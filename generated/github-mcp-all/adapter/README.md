...
- UPDATE: assign_copilot_to_issue, create_or_update_file, issue_write, label_write, mark_all_notifications_read, sub_issue_write, update_gist, update_pull_request, update_pull_request_branch
