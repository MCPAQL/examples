...
This directory stores the saved validation outputs for the generated Playwright MCP adapter.
...
- `differential-report.json` compares the generated adapter's introspection surface to the captured Playwright MCP discovery bundle and finalized adapter schema.
...
From `generated/playwright-mcp/`, regenerate the saved reports with:
