...
- Multi-device composition: a button on the XP-Pen Shortcut Remote keypad triggers AirPods recalibration via SIGUSR1
...
After step 5, head-pose-to-window-focus is live. Open the HUD at `http://127.0.0.1:47834/` to see live pose data and adapter status. Press your bound recenter key (or call `mcpaql_update.recenter`) when you want to realign.
